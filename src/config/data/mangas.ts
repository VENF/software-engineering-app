export const snk = {
  ...
  img:
    'https://m.supergeek.cl/noticias/site/artic/20200924/imag/foto_0000000220200924123353/ATTACKONTITAN_4TH.jpg',
  rating: 4.5,
  votes: '12.5k',
  sinopsis:
  ...
  price: 18.5,
  categories: ['accion', 'drama', 'fantasia', 'shounen']
};

export const jjk = {
  title: 'Jujutsu kaisen',
  img: 'https://pbs.twimg.com/media/EjUBPF8XsAAQQPY?format=jpg&name=4096x4096',
  rating: 4.8,
  votes: '10.5k',
  sinopsis:
  ...
  price: 19.99,
  categories: ['accion', 'demonios', 'terror', 'shounen']
};

export const hxh = {
  title: 'Hunter x Hunter',
  img: 'https://i.blogs.es/168d84/hunter-x-hunter/1366_2000.jpg',
  rating: 5,
  votes: '20.5k',
  sinopsis:
    'Gon Frecks,un niño de 12 años,vive con su tia Mito_san y su abuela en Isla Ballena,hunerfano de madre y segun su tia tambien de su padre.Un dia Gon es atacado por un oso del bosque,pero es salvado x un cazador quien le explica que esta en busca de su maestro para asi convertirse en un cazador,el es quien le dice que su padre Gin esta vivo. Enterado de esto Gon decide convertirse en cazador para poder encontrar a su padre...',
  price: 25.99,
  categories: ['accion', 'aventura', 'shounen']
};

export const deadmanwonderland = {
  title: 'Deadman wonderland',
  img: 'https://i.pinimg.com/originals/02/a1/eb/02a1ebf02a244c995ad700c4d8b74315.jpg',
  rating: 3.5,
  votes: '5.5k',
  sinopsis:
    'La historia transcurre en Tokyo 10 años después de un gran terremoto que hunde el 70% del territorio en el océano. Ganta Igarashi es un sobreviviente de 14 años y no recuerda nada sobre el incidente, vive una vida normal, hasta que un día en clase aparece un extraño sujeto rojo, que asesina a todos sus compañeros dejándolo vivo solo a él!! no sin antes introducir un cristal rojo en su pecho. Despues de ocurrido el crimen, Ganta es culpado por la masacre y sentenciado a cadena perpetua en la prisión llamada Deadman Wonderland. No es una prisión cualquiera, es un macabro lugar donde la principal atracción son los presos, sirviendo a la vez como Staff y Animadores. Debido a la cruel naturaleza del "crimen de Ganta" se suma una condena a muerte, colocandole un collar que inyecta lentamente una dosis de veneno, y para conseguir el antídoto, deberá participar en algunos mortales juegos, ademas debe encontrar al verdadero asesino para probar su inocencia.',
  price: 17.99,
  categories: ['accion', 'ciencia-ficcion', 'terror']
};

export const tokyoghoul = {
  title: 'Tokyo ghoul',
  img: 'https://pics.filmaffinity.com/Tokyo_Ghoul_Serie_de_TV-856840737-large.jpg',
  rating: 4.1,
  votes: '17.5k',
  sinopsis:
...
export const deathnote = {
  title: 'Death note',
  img:
    'https://vignette.wikia.nocookie.net/deathnote/images/7/76/DEATH_NOTE_anime.jpg/revision/latest?cb=20170720215429',
  rating: 5,
  votes: '20.5k',
  sinopsis:
  ...
  price: 20.99,
  categories: ['misterio', 'terror', 'psicologico']
};

export const sao = {
  title: 'Sword Art Online',
  img:
    'https://images.justwatch.com/poster/254572954/s718/sword-art.%7Bformat%7D',
  rating: 3,
  votes: '5.1k',
  sinopsis:
  ...
  price: 10.99,
  categories: ['accion', 'aventura', 'fantasia']
};